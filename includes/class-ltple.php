...
class LTPLE_App_Tumblr extends LTPLE_Client_App {
	...
	public function __construct ( $file='', $parent, $version = '1.0.0' ) {
		...
		$this->settings = new LTPLE_App_Tumblr_Settings( $this->parent );
		
		$this->admin = new LTPLE_App_Tumblr_Admin_API( $this );
		...
		$apps = $this->parent->apps->get_terms( 'app-type', array(
			...
			'tumblr' => array(
				...
				'options' 	=> array(
					...
					'thumbnail' => $this->parent->assets_url . 'tumblr.png',
	...
	/**
	 * Main LTPLE_App_Tumblr Instance
	 *
	 * Ensures only one instance of LTPLE_App_Tumblr is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see LTPLE_App_Tumblr()
	 * @return Main LTPLE_App_Tumblr instance
	 */
